...
The minimum API level is 21 at the time of writing the document, but search for AndroidApiLevelMin in this repo for more up-to-date information. _Note: The minimum API level has been raised to 24 in .NET 11._
