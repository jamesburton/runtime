...
public sealed unsafe partial class DacDbiImpl : IDacDbiInterface
{
    ...
    public int EnumerateLoaderHeapMemoryRanges(delegate* unmanaged<ulong, ulong, nint, void> fpCallback, nint pUserData)
        => LegacyFallbackHelper.CanFallback() && _legacy is not null ? _legacy.EnumerateLoaderHeapMemoryRanges(fpCallback, pUserData) : HResults.E_NOTIMPL;
