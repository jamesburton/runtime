...
public static class CoreCLRContracts
{
    public static void Register(ContractRegistry registry)
    {
        ...
        registry.Register<IObjectiveCMarshal>("c1", static t => new ObjectiveCMarshal_1(t,
            t.ReadGlobal<uint>(Constants.Globals.SyncBlockIsHashOrSyncBlockIndex),
            t.ReadGlobal<uint>(Constants.Globals.SyncBlockIsHashCode),
            t.ReadGlobal<uint>(Constants.Globals.SyncBlockIndexMask)));
